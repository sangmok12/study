...
public class Coffee {
	...
	public static void main(String[] args) {
		...
		if( n1 == 1) {
			...
			int n2 = scn.nextInt();
			if (n2 == 1)	System.out.println("설탕 넣은 아메리카노가 나왔습니다.");
			else if (n2 == 2) System.out.println("설탕없는 아메리카노가 나왔습니다.");
			...
			int n3 = scn.nextInt();
			if (n3 == 1)	System.out.println("연한맛의 다방커피가 나왔습니다.");
			else if (n3 == 2) System.out.println("단맛의 다방커피가 나왔습니다.");
			else if (n3 == 3) System.out.println("아주단맛의 다방커피가 나왔습니다.");
			else System.out.println("번호를 잘못 선택하셨습니다.");
		} else {
