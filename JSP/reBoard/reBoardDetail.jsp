...
<table>
	...
	<div style="width:600px;
			 	margin-top:10px;
			 	text-align:center;">
		<button type = "button" onclick="location='reBoardList.jsp?viewPage=<%=viewPage%>'">이전</button>
		...
		<button type = "button" onclick="location='replyWrite.jsp?gid=<%=gid %>&unq=<%=unq%>'">답변</button>
	</div>
